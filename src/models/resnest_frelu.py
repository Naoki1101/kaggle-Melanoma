...
def resnest101_frelu(pretrained=False, root='~/.encoding/models', **kwargs):
...
def resnest200_frelu(pretrained=False, root='~/.encoding/models', **kwargs):
...
def resnest269_frelu(pretrained=False, root='~/.encoding/models', **kwargs):
