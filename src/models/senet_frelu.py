...
class SEBottleneck(Bottleneck):
    ...
    def __init__(self, inplanes, planes, groups, reduction, stride=1,
        ...
        self.frelu1 = nn.ReLU(planes * 2)
        self.conv2 = nn.Conv2d(planes * 2, planes * 4, kernel_size=3,
                               stride=stride, padding=1, groups=groups,
                               bias=False)
        self.bn2 = nn.BatchNorm2d(planes * 4)
        self.frelu2 = nn.ReLU(planes * 4)
        self.conv3 = nn.Conv2d(planes * 4, planes * 4, kernel_size=1,
                               bias=False)
        self.bn3 = nn.BatchNorm2d(planes * 4)
        self.frelu3 = nn.ReLU(planes * 4)
...
def se_resnext50_32x4d_frelu(num_classes=1000, pretrained=True):
...
def se_resnext101_32x4d_frelu(num_classes=1000, pretrained=False):
